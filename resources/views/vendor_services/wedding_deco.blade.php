        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                    <div class="card text-white bg-secondary mb-3" style="max-width: 18rem;">
                            <div class="card-header">Wedding Deco 01</div>
                            <div class="card-body">
                          ...
                          <br>
                    <div class="card text-white bg-secondary mb-3" style="max-width: 18rem;">
                            <div class="card-header">Wedding Deco 04</div>
                            <div class="card-body">
                              <h5 class="card-title">Secondary card title</h5>
                              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card.</p>
                    ...
                    <div class="col-sm-3">
                            <div class="card text-light bg-secondary mb-3" style="max-width: 18rem;">
                                    <div class="card-header">Wedding Deco 02</div>
                                    <div class="card-body">
                                      <h5 class="card-title">Secondary card title</h5>
                                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card.</p>
                                      <h3>Are you want appoinment day</h3>
                          ...
                          <br>
                    <div class="card text-white bg-secondary mb-3" style="max-width: 18rem;">
                            <div class="card-header">Wedding Decor 05</div>
                            <div class="card-body">
                              <h5 class="card-title">Secondary card title</h5>
                              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card.</p>
                              <a class="dropdown-item" href="/vendor_services.hotel_services">Hotels Services</a>
                    ...
                    <div class="col-sm-3">
                            <div class="card text-dark bg-secondary mb-3" style="max-width: 18rem;">
                                    <div class="card-header">Wedding Deco 03</div>
                                    <div class="card-body">
                                      <h5 class="card-title">Secondary card title</h5>
                                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card.</p>
                                      {{--  <a class="dropdown-item" href="/vendor_services.hotel_services">Hotels Services</a>  --}}
                          ...
                          <br>
                    <div class="card text-white bg-secondary mb-3" style="max-width: 18rem;">
                            <div class="card-header">Wedding Deco 06</div>
                            <div class="card-body">
                              <h5 class="card-title">Secondary card title</h5>
                              <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card.</p>
                              <a class="dropdown-item" href="/vendor_services.hotel_services">Hotels Services</a>
